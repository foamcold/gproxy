                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">启用用户名密码登录方式</p>
                        </div>
                        <Switch
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <Label htmlFor="require_email_verification">需要邮箱验证</Label>
                            <p className="text-sm text-muted-foreground">注册时需要验证邮箱（需配置SMTP）</p>
                        </div>
                        <Switch
